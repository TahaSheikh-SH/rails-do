...
- [The Object Creation Hierarchy](#the-object-creation-hierarchy)
- [Arrange-Act-Assert (AAA)](#arrange-act-assert-aaa)
- [`aggregate_failures` for Shared-Setup Examples](#aggregate_failures-for-shared-setup-examples)
- [`build_stubbed` First](#build_stubbed-first)
- [`build` When Associations Must Be Traversable](#build-when-associations-must-be-traversable)
- [Mocks and Stubs for Collaborators and Interactions](#mocks-and-stubs-for-collaborators-and-interactions)
- [When `create` Is Acceptable](#when-create-is-acceptable)
- [Minimize Factory Trait Chains](#minimize-factory-trait-chains)
- [Factory Attribute Order](#factory-attribute-order)
- [`let` vs `let!`](#let-vs-let)
- [Use `let` Over Instance Variables](#use-let-over-instance-variables)
- [Declaration Order in Example Groups](#declaration-order-in-example-groups)
- [Shared Examples and Contexts: Use Sparingly](#shared-examples-and-contexts-use-sparingly)
- [Avoid Test-Induced Design Damage](#avoid-test-induced-design-damage)
- [No Inline Comments in Specs](#no-inline-comments-in-specs)
- [Named Subject](#named-subject)
- [Controlling Time: Always Use `travel_to`](#controlling-time-always-use-travel_to)
- [Use Verifying Doubles](#use-verifying-doubles)
- [Never Stub the System Under Test](#never-stub-the-system-under-test)
- [Do Not Test Private Methods](#do-not-test-private-methods)
- [Factory Sequences Are Not Test Data](#factory-sequences-are-not-test-data)
- [Naming: Contexts and Examples](#naming-contexts-and-examples)
- [Naming: `describe` Blocks](#naming-describe-blocks)
- [Constants in Specs: Use `stub_const`](#constants-in-specs-use-stub_const)
- [Stub HTTP Requests](#stub-http-requests)
- [Matchers](#matchers)
  - [Predicate Matchers](#predicate-matchers)
  - [Use Built-in Matchers](#use-built-in-matchers)
  - [`be` Without Arguments Is Too Broad](#be-without-arguments-is-too-broad)
- [System Specs: Use Semantic Selectors](#system-specs-use-semantic-selectors)
- [Diagnosing a Slow Suite](#diagnosing-a-slow-suite)
- [Run Tests in Random Order](#run-tests-in-random-order)
- [Profile Factories with test-prof](#profile-factories-with-test-prof)
- [Mutation Testing (Advanced)](#mutation-testing-advanced)
- [Testing Services That Wrap External Indexes](#testing-services-that-wrap-external-indexes)
  - [Prefer Stubs Over a Real Index](#prefer-stubs-over-a-real-index)
  - [Test Outcomes, Not Query Shape](#test-outcomes-not-query-shape)
  - [Stub at the Pipeline Boundary, Not at the Hit Level](#stub-at-the-pipeline-boundary-not-at-the-hit-level)
